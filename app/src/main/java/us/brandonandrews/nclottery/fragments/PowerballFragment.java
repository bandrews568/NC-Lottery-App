...
public class PowerballFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.powerball_resutls_fragment, container, false);
    }
    ...
    private void setupRecyclerView(View view) {
        powerballList = GameData.makeListOfPowerballDrawings(jsonObjectList, 200);
        resultsAdapter = new PowerballRecyclerAdapter(getActivity(), powerballList);
