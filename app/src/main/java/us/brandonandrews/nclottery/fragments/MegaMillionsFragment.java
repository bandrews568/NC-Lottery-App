...
public class MegaMillionsFragment extends android.support.v4.app.Fragment {
    ...
    private List<MegaMillions> megaMillionsList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.mega_millions_resutls_fragment, container, false);
    }

    @Override
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        progressBar = (ProgressBar) view.findViewById(R.id.progressBarMegaMillions);
    ...
    private void setupRecyclerView(View view) {
        megaMillionsList = GameData.makeListOfMegaMillionsDrawings(jsonObjectList, 200);
        resultsAdapter = new MegaMillionsRecyclerAdapter(getActivity(), megaMillionsList);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewMegaMillions);
